      ...
      <div className="flex-1 flex flex-col overflow-hidden pt-16 md:pt-0">
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          ...
          {selectedItem && selectedItem.result && (
            <div className="flex-1 bg-white flex flex-col md:ml-4 md:min-w-[600px]">
              {/* Inspector Header */}
              ...
              <div className="flex-1 flex flex-col md:flex-row overflow-auto md:overflow-hidden border-b border-gray-200">
